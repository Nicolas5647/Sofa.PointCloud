...
class OctreeLodFixture : public benchmark::Fixture {
public:
    PointCloudOctreeLodSelector* selector;
    ...
    void SetUp(const ::benchmark::State& state) override {
        ...
        selector = new PointCloudOctreeLodSelector();
        ...
        selector->d_thresholds.setValue({10, 20, 30});
        selector->initOctree();
...
BENCHMARK_DEFINE_F(OctreeLodFixture, query_static)(benchmark::State& st) {
...
BENCHMARK_DEFINE_F(OctreeLodFixture, query_approach_recede)(benchmark::State& st) {
    std::vector<int> results;
    double step = 0.0;
...
BENCHMARK_DEFINE_F(OctreeLodFixture, query_up_down)(benchmark::State& st) {
    std::vector<int> results;
    double step = 0.0;
    const double dt = 0.01;
...
BENCHMARK_DEFINE_F(OctreeLodFixture, query_left_right)(benchmark::State& st) {
    std::vector<int> results;
    double step = 0.0;
    const double dt = 0.01;
...
BENCHMARK_REGISTER_F(OctreeLodFixture, query_static)->Arg(1000)->Arg(5000)->Arg(10000);
BENCHMARK_REGISTER_F(OctreeLodFixture, query_approach_recede)->Arg(1000)->Arg(5000)->Arg(10000);
BENCHMARK_REGISTER_F(OctreeLodFixture, query_up_down)->Arg(1000)->Arg(5000)->Arg(10000);
BENCHMARK_REGISTER_F(OctreeLodFixture, query_left_right)->Arg(1000)->Arg(5000)->Arg(10000);
